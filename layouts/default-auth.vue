                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <NuxtLink to="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">ToDo</span>
                            </NuxtLink>
                        </div>
                        <!-- /Logo -->
                        <slot />
...
useHead({
    link: [
        ...
        // Page
        {
            rel: "stylesheet", href: "/sneat-1.0.0/assets/vendor/css/pages/page-auth.css"
        }
    ],
    script: [
        // Config
        {
            src: "/sneat-1.0.0/assets/js/config.js",
            tagPosition: 'head'
        },
        // Main JS
        // {
